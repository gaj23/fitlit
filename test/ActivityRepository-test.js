...
describe('ActivityRepo', () => {
  ...
  it('should calculate average stairs climbed for all users for a specific date', () => {
    expect(activityRepo.getAvgStairsClimbedForAllUsers('2019/06/15')).to.equal('19.7');
  });

  it('should calculate average steps taken for all user for a specific date', () => {
    expect(activityRepo.getAvgStepsForAllUsers('2019/06/15')).to.equal(5091);
  });

  it('should calculate average minutes active for all user on a specific date', () => {
